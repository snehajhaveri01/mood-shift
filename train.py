...
#     }
#     df = pd.DataFrame(data).map(str.lower)
#     with open("activities.json", "r") as file:
#         activities = json.load(file)
#     df['Activities'] = [activities] * 6
#     return df
...
#     activities = predict_and_suggest_activities(model, encoder, text_transformer, df, mood, aspect, reason, place)
